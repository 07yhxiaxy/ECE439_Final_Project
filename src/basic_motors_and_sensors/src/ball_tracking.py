...
# Set up a Publisher
## 1st argument: topic; 2nd arg: message type; 3rd arg: queue_size - use 1 if you only want the latest to be read. 
coordinates = rospy.Publisher('/positions',position_message,queue_size=1)
